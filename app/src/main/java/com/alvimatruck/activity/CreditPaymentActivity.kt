...
import com.alvimatruck.databinding.ActivityCreditPaymentBinding
...
class CreditPaymentActivity : BaseActivity<ActivityCreditPaymentBinding>(), DeletePhotoListener {
    ...
    override fun inflateBinding(): ActivityCreditPaymentBinding {
        return ActivityCreditPaymentBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imagesListAdapter = ImagesListAdapter(
            this@CreditPaymentActivity, listProofImageUri, this
        )
        ...
        binding.tvSubmit.setOnClickListener {
            ...
            if (selectedCustomer == null) {
                Toast.makeText(this, "Please select customer", Toast.LENGTH_SHORT)
                    .show()
    ...
    private fun dialogSingleSelection() {
        ...
        etBinSearch.hint = "Search Customer"
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            try {
                val compressedUri = withContext(Dispatchers.IO) {
                    ...
                    Utils.getCompressedUri(this@CreditPaymentActivity, uri)
                }
                ...
                e.printStackTrace()
                Toast.makeText(
                    this@CreditPaymentActivity, "Error processing image", Toast.LENGTH_SHORT
                ).show()
            } finally {
                ProgressDialog.dismiss()
            }
