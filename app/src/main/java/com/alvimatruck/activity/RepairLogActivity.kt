...
class RepairLogActivity : BaseActivity<ActivityRepairLogBinding>(), DeletePhotoListener {
    ...
    override fun inflateBinding(): ActivityRepairLogBinding {
        return ActivityRepairLogBinding.inflate(layoutInflater)
    }
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            try {
                val compressedUri = withContext(Dispatchers.IO) {
                    ...
                    Utils.getCompressedUri(this@RepairLogActivity, uri)
                }
                ...
                e.printStackTrace()
                Toast.makeText(
                    this@RepairLogActivity, "Error processing image", Toast.LENGTH_SHORT
                ).show()
            } finally {
                ProgressDialog.dismiss()
            }
