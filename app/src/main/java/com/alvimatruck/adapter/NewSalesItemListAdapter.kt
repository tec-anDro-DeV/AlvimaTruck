...
class NewSalesItemListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = SingleNewSalesItemBinding.inflate(layoutInflater, parent, false)
    ...
    class ViewHolder(var binding: SingleNewSalesItemBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}