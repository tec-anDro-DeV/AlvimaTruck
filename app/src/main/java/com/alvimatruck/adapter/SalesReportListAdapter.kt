...
class SalesReportListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = SingleSalesReportItemBinding.inflate(layoutInflater, parent, false)
    ...
    class ViewHolder(var binding: SingleSalesReportItemBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}